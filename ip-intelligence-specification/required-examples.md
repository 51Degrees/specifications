...
parameters, such as cloud resource keys, or IP intelligence license keys.
...
- a helper that creates an IPI Engine to provide access to the data file
...
51Degrees generates Web documentation ([for example](https://51degrees.com/documentation/_examples__ip_intelligence__getting_started__console__on_premise.html))
...
[extension methods](https://github.com/51Degrees/ip-intelligence-dotnet-examples/blob/main/Examples/ExampleBase/ExampleUtils.cs)
to provide the same functionality.

### Test Data

Many examples require test data consisting of IP address strings.
As this is a known format, with limited permutations, the source
is randomly generated rather than storing a file.
...
distributed in [GitHub](https://github.com/51Degrees/ip-intelligence-data)
on a monthly basis.
...
[.NET](https://github.com/51Degrees/ip-intelligence-dotnet-examples/blob/main/Examples/sample-configuration.json)
...
See documentation
[on-premise](https://51degrees.com/documentation/_examples__ip_intelligence__getting_started__console__on_premise.html)
...
The example also illustrates the availability of IP intelligence Properties
...
See documentation
[on-premise](https://51degrees.com/documentation/_examples__ip_intelligence__getting_started__web__on_premise.html)
...
See documentation [on-premise](https://51degrees.com/documentation/_examples__ip_intelligence__metadata__on_premise_hash.html),
...
various performance options available (Low Memory, Max Performance, etc.)
which are commented out in the example.

Implementors might consider illustrating the differences between the various
combinations of options.

[See documentation](https://51degrees.com/documentation/_examples__ip_intelligence__offline_processing__on_premise.html)
...
[See documentation](https://51degrees.com/documentation/_examples__ip_intelligence__performance__on_premise.html).
...
[See documentation](https://51degrees.com/documentation/_examples__ip_intelligence__data_file_updates__automatic.html)
