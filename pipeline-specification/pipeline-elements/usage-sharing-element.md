...
permitted in XML. In order to handle this, a function will need to be implemented
to sanitize the values before they are added to the XML.

Where changes need to be made, attributes are added to the XML element
...
Note that certain Evidence values MUST NOT be included in this check
